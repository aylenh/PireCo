...
class CashIncome extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        # Row exist?
        if(DB::table('cashincome')->count() == 0):
            DB::insert('insert into cashincome (
                service1,
                price1,
                service2,
                price2,
        ...
        return view('cashincome', ['generalModul'=> 'Configuraciones', 'parenModul' => 'Altas Generales', 'modulName' => 'Ingresos por Caja'
    ...
    {
        return DB::table('cashincome')->select('cashincome.*')->get();
    }
    ...
    {
        return DB::table('cashincome')->update([
    ...
    {
        return DB::table('cashincome')->where('id', $id)->delete();
    }
}
