                        ...
                        <td align="center" class="section-img">
                            <a href=""
                                style=" border-style: none !important; display: block; border: 0 !important;"><img
                                    src="https://images.pexels.com/photos/327090/pexels-photo-327090.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 24px">
                                            ...
                                            Detalle: <strong>{{ $pedido->pedido_detalle }}</strong>
                                        </div>

                                        <div style="line-height: 24px">

                                            Monto: <strong>{{ $pedido->pedido_monto }}</strong>
                                        </div>
                                        <div style="line-height: 24px">

                                            Tipo de pago: <strong>{{ $pedido->pedido_pago }}</strong>
                                        </div>
                                        <div style="line-height: 24px">

                                            Distribuidora: <strong>{{ $pedido->pedido_distribuidora }}</strong>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div
                                            ...
                                            Contactanos: <br /> <a href="mailto:"
                                                style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">albertoitoeste@gmail.com</a>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">© Copyright PirenCo.
