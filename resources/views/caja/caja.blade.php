                                      ...
                                      <div class="">
                                          ...
                                          @if(!$mainview)
                                              ...
                                              @if($day == date('Y-m-d'))
                                                ...
                                                <!-- Cargar un Egreso -->
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#egreso">
                                                  Cargar un Egreso
                                                </button>
                                            ...
                                            @if(isset($incomesResumeMonthly) && isset($outcomesResumeMonthly))
                                              <div class="row w-100">
                                                <div class="">
                                                  <h3 class="m-0 font-weight-bold text-primary">Balance del Mes Corriente (Unicamente de esta Caja)</h3>
                                                  <br>
                                                  <table class="table borderless table-hover" style="max-width: 380px;">
                                                      <thead>
                                                        <tr>
                                                          <th scope="col" class="text font-weight-bold text-primary" style="font-weight: bold; background: lightgray;">Ingresos</th>
                                                          <th scope="col" class="text font-weight-bold text-primary" style="font-weight: bold; background: lightgray;">Egresos</th>
                                                          <th scope="col" class="text font-weight-bold text-primary" style="font-weight: bold; background: lightgray;">Resultado</th>
                                                        </tr>
                                                      </thead>
                                                      <tbody id="tableCash">
                                                          <tr>
                                                            ...
                                                            <td>$ @php echo $incomesResumeMonthly[0]->Suma - $outcomesResumeMonthly[0]->Suma; @endphp
                                                            </td>
                                                          </tr>
                                                      </tbody>
                                                  </table>
