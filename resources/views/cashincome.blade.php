...
<form>
      <div class="container my-lg">
          <h2 class="doc-section-title" id="title">Ingresos por Caja<a class="section-link" href="#examples"></a><span class="border-bottom"></span></h2>
              ...
              <div class="row">
                  <div class="col-md-6">
                      <form>
                          ...
                          @endfor
                          <br>
                          <button id="create" type="button" class="btn btn-raised-primary" onclick="edit_row();">Guardar Ingresos por Caja</button>
                      </form>
                  </div>
              </div>
          </div>
